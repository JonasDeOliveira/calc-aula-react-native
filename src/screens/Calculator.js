...
const initialState = {
 ...
 export default class Calculator extends Component {
    ...
    addDigit = digit => {
        ...
        const displayValue = currentValue + digit //concatena digitos
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.buttons}>
                    <Button label='AC' onTouch={this.clearMemory} threeCollumns/>
                    ...
                    <Button label='+' onTouch={this.setOperation} operation/>
                    <Button label='0' onTouch={this.addDigit} twoCollumns/>
